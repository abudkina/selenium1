...
//        Assert.assertEquals("Terms - OnVoya", driver.getTitle());}
    ...
    public void Paris_Picture(){
        ...
        String title = driver.findElement(By.xpath("//*[@id=\"portlet_56_INSTANCE_V0t4fK4V4X3A\"]/div/div/div/div[1]/div/div[1]/div/div/div[1]/h2")).getText();
        String information = driver.findElement(By.xpath("//*[@id=\"portlet_56_INSTANCE_V0t4fK4V4X3A\"]/div/div/div/div[1]/div/div[1]/div/div/div[1]/h2")).getText();
        String weather = driver.findElement(By.xpath("//*[@id=\"portlet_56_INSTANCE_V0t4fK4V4X3A\"]/div/div/div/div[1]/div/div[2]/div[1]/div[1]/h4")).getText();
        String airport = driver.findElement(By.xpath("//*[@id=\"portlet_56_INSTANCE_V0t4fK4V4X3A\"]/div/div/div/div[1]/div/div[3]/div/div/div[2]/h3")).getText();
