...
public class Booking {
    ...
    @Test
    public void Cheapoair_Smartfares_FareDepot_FareStreet() {

        driver.navigate().to("https://www.onvoya.com/flights/search?From=LAX&To=BOS&Class=E&Departure=2018-03-04&Return=2018-03-08&Adult=1&Ref=WF11\"");
        Fares ("Cheapoair");
        Fares ("Smartfares");
        Fares ("FareDepot");
        Fares ("FareStreet"); }
    ...
    @Test
    public void Kiwi_Expedia_Opodo() {
    ...
    @Test
    public void American_Edreams() {

        driver.navigate().to("https://www.onvoya.com/flights/search?From=LAX&To=LAS&Class=E&Departure=2018-03-04&Adult=1&Ref=WF11");
